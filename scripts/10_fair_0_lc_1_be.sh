...
PID_BE=$!
time taskset -c 20 nice -n $NICE /home/zzh/rocksdb/db_bench -benchmarks=readrandom \
	-disable_auto_compactions=1 -use_direct_reads=1 -block_size=4096 -key_size=16 \
